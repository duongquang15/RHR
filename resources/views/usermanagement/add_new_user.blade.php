    ...
    <div id="auth">
        <div class="row h-100">
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    <div class="auth-logo">
                        <a href="index.html"><img src="{{ URL::to('assets/images/logo/logo1.png') }}" alt="Logo"></a>
                    </div>
                    <h1 class="auth-title">New Account</h1>
                    <p class="auth-subtitle mb-5">Input your imformation.</p>

                    <form method="POST" action="{{ route('user.store') }}" class="md-float-material" enctype="multipart/form-data">
                        @csrf
