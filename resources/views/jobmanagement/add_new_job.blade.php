                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('job.store') }}" class="md-float-material" enctype="multipart/form-data">
                        ...
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input type="text" class="form-control form-control-lg @error('priority') is-invalid @enderror" name="priority" value="{{ old('priority') }}" placeholder="Vui lòng nhập priority">
                        ...
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input type="date" class="form-control form-control-lg @error('onboard_date') is-invalid @enderror" name="onboard_date" value="{{ old('onboard_date') }}" placeholder="Vui lòng nhập request date">
                            <div class="form-control-icon">
                                <i class="bi bi-calendar-event"></i>
                            </div>
                            @error('onboard_date')
                        ...
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input type="text" class="form-control form-control-lg @error('salary') is-invalid @enderror" name="salary" value="{{ old('salary') }}" placeholder="Vui lòng nhập salary">
                            <div class="form-control-icon">
                        ...
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input type="text" class="form-control form-control-lg @error('amount') is-invalid @enderror" name="amount" value="{{ old('amount') }}" placeholder="Vui lòng nhập amount">
                            <div class="form-control-icon">
                        ...
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input type="text" class="form-control form-control-lg @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" placeholder="Vui lòng nhập name">
                            <div class="form-control-icon">
