            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-content">
                        <form class="form form-horizontal" action="{{ route('candidate.updatestatus', $data[0]->id) }}"
                            ...
                            <div class="card-body">
                                <div class="form-body">
                                    <div class="row" style="display:flex">
                                        <div class="col-9">
                                            <div style="margin-right:10px; border-radius:10px;background:gainsboro; margin:5px;display:flex">
                                                <h6 style="padding: 1.5rem;width: 700px;" >Thông tin ứng viên</h6>
                                                                    ...
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <form>
                                                                            ...
                                                                            <div class="modal-footer">
                                                                                ...
                                                                                <input type="submit"
                                                                                    formaction="{{ route('addCalendar', $data[0]->id) }}"
                                                                                    value="Add lịch"
                                                    ...
                                                    @elseif($data[0]->status == 3)
                                                        ...
                                                        @if (!is_null($data[0]->desired_salary))
                                                            <form action="" method="PUT">
                                                                <button class="btn btn-info" name="status"
                                                                    value="{{ $data[0]->status + '1' }}"
                                                                    style="padding:0px 10px !important; height:38px">Đồng
                                                                    ý Offer</button>

                                                            </form>
                                                            
                                                            <form action="{{ route('candidate.destroy', $data[0]->id) }}" type="submit" method='post' style="display:inherit">
                                                                @csrf
                                                                @method('delete')
                                                                <button type="submit" style="border:none;padding:0;background: none;" !important onclick="return confirm('Are you sure to want to delete it?')"><span class="badge bg-danger" style="width: 50pt;height: 38px;margin-left: 5px;padding-top: 10px;">Từ chối</i></span></button>
                                                            </form>
                                                        @endif
                                                                        ...
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body">
                                                                                <div
                                                                                    class="form-group position-relative has-icon-left mb-4">
                                                                                    <input type="text"
                                                                                        class="form-control form-control-lg @error('desired_salary') is-invalid @enderror"
                                                                                        name="desired_salary"
                                                                                        value="{{ old('desired_salary') }}"
                                                                                        placeholder="Mức lương" required>
                                                                                    <div class="form-control-icon">
                                                                                        <i class="bi bi-list-ol"></i>
                                                                                    </div>
                                                                            ...
                                                                            <div class="modal-footer">
                                                                                <div type="button" class="btn btn-danger"
                                                                                    data-dismiss="modal">Close</div>
                                                                                <input type="submit"
                                                                                    formaction="{{ route('offerCandidate', $data[0]->id) }}"
                                                                                    value="Offering"
                                                                                    class="btn btn-primary">
                                                                            </div>
                                                            </form>
                                    ...
                                    @else
                                        <button class="btn btn-info" name="status" value="{{ $data[0]->status + '1' }}"
                                            style="padding-left:10px;margin-top: -11px;">Chuyển đổi trạng thái</button>
                                        @endif
                                    </div>
                                </div><br><br>
                                <div style="display:flex">
                            ...
                            <div class="col-3">
                                ...
                                <div>
                                    <div class="stepper d-flex flex-column mt-5 ml-2">
                                        <div class="d-flex mb-1">
                                            <div class="d-flex flex-column pr-4 align-items-center">
                                                <div class="rounded-circle py-2 px-3 bg-primary text-white mb-1"
                                                    @if ($data[0]->status >= 1) style="background:#435ebe !important" @endif>
                                                    1</div>
                                        ...
                                        <div class="d-flex mb-1">
                                            <div class="d-flex flex-column pr-4 align-items-center">
                                                <div class="rounded-circle py-2 px-3 bg-secondary text-white mb-1"
                                                    @if ($data[0]->status >= 2) style="background:#435ebe !important" @endif>
                                                    2</div>
                                                <div class="line h-100"></div>
                                            </div>
                                            <div>
                                        ...
                                        <div class="d-flex mb-1">
                                            <div class="d-flex flex-column pr-4 align-items-center">
                                                <div class="rounded-circle py-2 px-3 bg-secondary text-white mb-1"
                                                    @if ($data[0]->status >= 3) style="background:#435ebe !important" @endif>
                                                    3</div>
                                                <div class="line h-100"></div>
                                            </div>
                                            <div>
                                        ...
                                        <div class="d-flex mb-1">
                                            <div class="d-flex flex-column pr-4 align-items-center">
                                                <div class="rounded-circle py-2 px-3 bg-secondary text-white mb-1"
                                                    @if ($data[0]->status >= 4) style="background:#435ebe !important" @endif>
                                                    4</div>
                                                <div class="line h-100"></div>
                                            </div>
                                            <div>
                                        ...
                                        <div class="d-flex mb-1">
                                            <div class="d-flex flex-column pr-4 align-items-center">
                                                <div class="rounded-circle py-2 px-3 bg-secondary text-white mb-1"
                                                    @if ($data[0]->status == 5) style="background:#435ebe !important" @endif>
                                                    5</div>
